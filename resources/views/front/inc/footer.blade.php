                ...
                <div class="footer-widget">
                    ...
                    <div class="widget-title">
                        <h2>want <span>to Take</span><br>
                            your good boy, <span>our Shop</span>?</h2>
                    </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-widget one mb-0">
                    ...
                    <div class="download-link">
                        <ul>
                            <li><a href="#"><img
                                        src="https://demo.egenslab.com/html/scooby/preview/assets/images/icon/google-play.svg"
                                        alt></a></li>
                            <li><a href="#"><img
                                        src="https://demo.egenslab.com/html/scooby/preview/assets/images/icon/app-store.svg"
                                        alt></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="payment-mathord">
                        <ul>
                            <li><a href="#"><img
                                        src="https://demo.egenslab.com/html/scooby/preview/assets/images/icon/visa.svg"
                                        alt></a></li>
                            <li><a href="#"><img
                                        src="https://demo.egenslab.com/html/scooby/preview/assets/images/icon/master-card.svg"
                                        alt></a></li>
                            <li><a href="#"><img
                                        src="https://demo.egenslab.com/html/scooby/preview/assets/images/icon/amarican-ex.svg"
                                        alt></a></li>
                            <li><a href="#"><img
                                        src="https://demo.egenslab.com/html/scooby/preview/assets/images/icon/maestro.svg"
                                        alt></a></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="row border-top align-items-center">
            <div class="col-lg-6">
                <div class="copyright-area">
                    <p>© 2025 - <?php echo date('Y'); ?> D&G Petite Pups is Proudly Powered by <a
                            href="https://afraym.com">Afraym</a>.</p>
                </div>
            </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-timepicker/1.14.1/jquery.timepicker.min.js"
    integrity="sha512-TYfUH4Mbt6NcWkJI7RS5MoMqFSkpBCChADy2EjAiFr5ckAdTjOUUjnTA3GH8PQAIa2Nz7eR/4PR9xXY3uhnu/A=="
