            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <img src="/users/{{ $user->image}}" alt="{{ $user->metaTitle}}" class="img-thumbnail" style="width: 20%; height:20%">
                  </td>
                  <td>
                    <a href="{{ Route('admin.user.edit', $user->id) }} "><button class="btn btn-info">Edit</button></a>
                  </td>
                  <td class="text-right">
                    <button class="btn btn-danger deleteitem" data-toggle="modal" data-target="#deleteModal" data-id="{{ $user->id }}" >Delete</button>
                  </td>
                </tr>
                @endforeach
              </tbody>
